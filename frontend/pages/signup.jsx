...
export default function SignupPage() {
  ...
  async function handleSignup(e) {
    e.preventDefault();
    if (!auth) {
      setError('Auth is not configured. Add Firebase env vars to enable signup.');
      return;
    }
    const v = validate();
      ...
      <section className="relative min-h-[calc(100vh-80px)] overflow-hidden">
        ...
        <div className="relative mx-auto max-w-md px-6 pt-24 pb-16">
          <div className="rounded-2xl bg-white/10 border border-white/15 backdrop-blur-xl p-8 shadow-2xl">
            <h1 className="text-white text-2xl font-extrabold mb-2">Create your account</h1>
            <p className="text-white/70 mb-6">Join ClarityAI and begin your wellness journey.</p>
